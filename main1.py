...
w = sp.Piecewise(           #Hier mache ich die beiden Einzelregionen into one
    (w1, r <= Rp),  #solange 0 <= r <= Rp, Region 1 Piezo Radius 
    (w2, r > Rp)    #sobald r > Rp sind wir in Region 2
)

params = {
    Dm:110e-6, Em:170e9, Dp:190e-6, Ep:65e9,
    Rm:3.35e-3, Rp:3e-3, d31:2e-12, E33:150e9,
    p:100, nu:0.30, D:0.125 #this D value is grossly approximated. like most others for now
}
